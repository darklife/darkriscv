...
yosys -D __YOSYS__ -D LATTICE_ECP5_COLORLIGHTI9 -p "synth_ecp5 -json darksocv.json -top darksocv" ../../rtl/darksocv.v ../../rtl/darkriscv.v ../../rtl/darkuart.v pll_ref_25MHz.v
